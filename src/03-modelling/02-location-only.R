...
# Allow SD params to vary by location:
...
models <-  list(
  ...
  list(
    tag="country_county_village_group",
    data=indicator_data,
    formula=bf(tva ~ 1 +
                 (1 | iso_country_code) +
                 (1 | gr(iso_country_code:gdlcode, by=iso_country_code)) +
  ...
  list(
    tag="country_county_village_kg_group",
    data=indicator_data,
    formula=bf(tva ~ 1 +
                 (1 | iso_country_code) +
                 (1 | gr(iso_country_code:gdlcode, by=iso_country_code)) +
  ...
  list(
    tag="country_county_village_kg_form_group",
    data=indicator_data,
    formula=bf(tva ~ 1 +
                 (1 | iso_country_code) +
                 (1 | gr(iso_country_code:gdlcode, by=iso_country_code)) +
  ...
  list(
    tag="country_county_village_form_group",
    data=indicator_data,
    formula=bf(tva ~ 1 +
                 (1 | iso_country_code) +
                 (1 | gr(iso_country_code:gdlcode, by=iso_country_code)) +
  ...
  list(
    tag="country_village_form_group",
    data=indicator_data,
    formula=bf(tva ~ 1 +
                 (1 | iso_country_code) +
                 (1 | gr(iso_country_code:gdlcode:village,by=iso_country_code))+
  ...
  list(
    tag="country_kg_form_group",
    data=indicator_data,
    formula=bf(tva ~ 1 +
                 (1 | iso_country_code)+
                 (1 | kg_class_name)+
                 (1 | gr(id_form, by=iso_country_code)))
  ),
  list(
    tag="country_kg_form",
    data=indicator_data,
...
dir.create(paste0(opt$output,"/overall_models/location_only/tva"))
